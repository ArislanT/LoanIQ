...
import type { PrivateLender } from '@/app/lib/privateLenders';
...
export default function PrivateLoanCard({ loan, isTopPick = false, topPickLabel }: PrivateLoanCardProps) {
  return (
    <div className={`bg-white rounded-xl p-4 ${isTopPick ? 'border-2 border-capital-blue shadow-lg' : 'border border-gray-200'}`}>
      ...
      <div className="space-y-3 mb-4">
        <div>
          <div className="text-xs text-gray-500 font-semibold">APR Range</div>
          <div className="text-sm font-semibold text-capital-blue">{loan.aprRange}</div>
        </div>
        ...
        <div>
          <div className="text-xs text-gray-500 font-semibold">Loan Amounts</div>
          <div className="text-sm text-gray-700">{loan.loanAmounts}</div>
        </div>
        
        <div>
          <div className="text-xs text-gray-500 font-semibold">Cosigner Requirement</div>
          <div className="text-sm text-gray-700">{loan.cosignerRequirement}</div>
        </div>
      </div>
